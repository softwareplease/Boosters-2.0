export class Board {
    ...
    constructor() {
        this.boardOfDirectors = [
            ...
            {name: 'Ann Byczek', position: 'Corresponding Secretary', email: 'Lkann1@aol.com'},
            {name: 'Lisa Mullen Cimino', position: 'Membership Secretary/Booster Bucks Coordinator', email: 'lmullencimino@sbcglobal.net'}
        ];
        this.athleticOffice = [
            {name: 'Sean Jackson', position: 'Athletic Director', email: 'sean.jackson@lakewoodcityschools.org'},
            {name: 'Anne Giffels', position: 'Athletic Director Secretary', email: 'anne.giffels@lakewoodcityschools.org'}
        ];
        this.delegates = [
...
//Athletic Office phone number - 529-4034
